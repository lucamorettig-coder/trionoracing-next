...
import { MapPin, Users, ArrowRight, Trophy } from "lucide-react";
 ...
 * un badge "In programma" / "Conclusa" e link alla scheda gara genitore.
 */
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 mt-4">
          ...
          <span className="inline-flex items-center gap-1 text-[13px] font-semibold whitespace-nowrap text-navy-700">
            Vedi gara
