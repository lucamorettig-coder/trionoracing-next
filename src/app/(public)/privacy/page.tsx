    ...
    <div data-livery="racing" className="bg-stage-bg text-stage-ink">
      ...
      <div className="max-w-[820px] mx-auto px-6 lg:px-10 py-20 lg:py-28">
        ...
        <SectionHead
          ...
          intro="Informativa resa ai sensi degli artt. 13-14 del Regolamento (UE) 2016/679 (GDPR) e del D.Lgs. 196/2003 e s.m.i. (Codice Privacy)."
        />
        ...
        <div className="mt-12 space-y-10 reveal reveal-delay-1">
          ...
          <ApexLegalSection title="2. Tipologie di dati, finalità e basi giuridiche">
          ...
          <ApexLegalSection title="3. Categorie particolari di dati (salute dei minori)">
            <p>
          ...
          <ApexLegalSection title="4. Minori">
            <p>
          ...
          <ApexLegalSection title="6. Destinatari e responsabili esterni (data processor)">
            <p>
          ...
          <ApexLegalSection title="8. Periodi di conservazione">
            <RetentionTable />
          </ApexLegalSection>

          <ApexLegalSection title="9. Diritti dell'interessato">
            <p>
          ...
          <ApexLegalSection title="10. Modifiche">
            <p>
          ...
          <ApexLegalSection
            title="11. Cancellazione dati da accesso social (Facebook)"
            id="cancellazione-dati"
          >
            <p>
            ...
            <ul className="list-disc pl-6 space-y-1.5 mt-2">
              <li>
                ...
                <Link href="/portale" className="text-accent underline underline-offset-2">
                  /portale
                </Link>{" "}
        ...
        <div className="mt-16 pt-8 border-t border-stage-line flex flex-wrap items-center justify-between gap-4 reveal">
          ...
          <div className="text-sm text-stage-ink-dim flex gap-4">
            <Link href="/cookie" className="text-accent underline underline-offset-2">
              Cookie policy
            </Link>
...
function LegalBlock({ origin, url, data, purpose, base, retention }: LegalBlockProps) {
  return (
    <div className="mt-5 bg-stage-surface border border-stage-line rounded-[var(--radius-lg)] p-5 lg:p-6 space-y-3">
      <div className="flex flex-wrap items-baseline gap-2">
        <h3 className="text-base font-bold text-stage-ink">{origin}</h3>
        {url && (
          <Link
            href={url}
            className="text-xs font-mono text-accent hover:text-stage-ink underline underline-offset-2"
          >
            {url}
          </Link>
        )}
      ...
      <div>
        <span className="text-xs font-bold uppercase tracking-wider text-accent">Dati</span>
